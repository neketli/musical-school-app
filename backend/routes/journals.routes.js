...
router.put('/journals/:id', jwtAuthMiddleware, journalsController.updateJournals)
router.delete('/journals/:id', jwtAuthMiddleware, journalsController.deleteJournals)
